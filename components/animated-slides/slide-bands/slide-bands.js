...
import animationData from "./animation-assets/v2_bands.json";
import animationDataBig from "./animation-assets/v2_bands.json";
...
class ControlledLottie71 extends Component {
  ...
  componentDidMount(){
    ...
    document.getElementById("bipocbands__fallback").addEventListener("click", function(){
      animObj.play();
    })

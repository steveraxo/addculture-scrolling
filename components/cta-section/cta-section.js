                        ...
                        <div className="row">
                            <div className="col-sm-12 col-lg-8 slide__fifteen__left">
                                <h2 className="avant">
                                    ...
                                    className="white__text">WE AMPLIFY </motion.span>
                                    ...
                                    className="white__text">THE VOICES THAT </motion.span>
                                    <motion.span 
                                    animate={visible ? "open" : "closed"}
                                    variants={variations}
                                    transition={{ duration: 0.9, type: "spring", stiffness: 50,  delay: 0.3 }}
                                    className="rose__text">SET THE TONE</motion.span>
                                </h2>
                                <motion.p className="avant"
                                    animate={visible ? "open" : "closed"}
                                    variants={variations}
                                    transition={{ duration: 0.9, type: "spring", stiffness: 50,  delay: 0.4 }}
                                >
